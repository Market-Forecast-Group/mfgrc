 ...
 */
public class AutoStrategyPlugin extends AbstractUIPlugin {

	// The plug-in ID
	public static final String PLUGIN_ID = "com.mfg.strategy.automatic"; //$NON-NLS-1$

	// The shared instance
	private static AutoStrategyPlugin plugin;

	/**
	 * The constructor
	 */
	public AutoStrategyPlugin() {
	}
	 ...
	 */
	public static AutoStrategyPlugin getDefault() {
		return plugin;
	}
	...
	public void logError(String errorPar, Throwable throwable) {
		...
		if (error == null && throwable != null) {
			// TODO Review error assignment. It's generating a warning.
	...
	public void logInfo(String messagePar, Throwable throwable) {
		...
		if (message == null && throwable != null) {
			// TODO Review message assignment. It's generating a warning.
