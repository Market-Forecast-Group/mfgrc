 ...
 * <li>{@link TradeMDB#replace_eventTime(long, long)}: To replace the eventTime value.</li>
 ...
 *
 * @see BaseChartMDBSession#connectTo_TradeMDB(String)
 */
...
/* END USER MDB */
	...
	*/	
	...
	private ByteBuffer _replaceBuffer_eventTime;
	 ...
	 */
	public TradeMDB(BaseChartMDBSession session, File file, int bufferSize, SessionMode mode) throws IOException {
		...
		if (!_memory) {		
			_replaceBuffer = ByteBuffer.allocate(104);		
			...
			_replaceBuffer_eventTime = ByteBuffer.allocate(8);
...
/* END RECORD EXTENDS */	{
		...
		*/
		...
		/**
		* Represents the eventTime column.
		* <h2>Definition</h2>
		* <table border=1>
		* <caption>Definition of eventTime</caption>
		* <tr><td>Column</td><td>eventTime</td></tr>
		* <tr><td>Type</td><td>LONG</td></tr>
		* <tr><td>Order</td><td>ASCENDING</td></tr>
		* <tr><td>Virtual</td><td>No</td></tr>
		* </table>
		*/
		public long eventTime; /* 8 */
		/**
		...
		* </table>
		*/
		public long openPhysicalTime; /* 12 */
		/**
		...
		* </table>
		*/
		public long closePhysicalTime; /* 13 */
		/**
		...
		* </table>
		*/
		public long eventPhysicalTime; /* 14 */
		/**
		...
		* </table>
		*/
		public int opening0_childType; /* 15 */
		/**
		...
		* </table>
		*/
		public int opening1_childType; /* 16 */
		/**
		...
		* </table>
		*/
		public int opening0_orderId; /* 17 */
		/**
		...
		* </table>
		*/
		public int opening1_orderId; /* 18 */
		...
		*/
		...
		public Object get(int columnIndex) {
			switch(columnIndex) {
				...
				case 9: return openingCount;
				case 10: return opening0;
				case 11: return opening1;
				case 12: return openPhysicalTime;
				case 13: return closePhysicalTime;
				case 14: return eventPhysicalTime;
				case 15: return opening0_childType;
				case 16: return opening1_childType;
				case 17: return opening0_orderId;
				case 18: return opening1_orderId;
...
/**
	...
	public final class Appender implements IAppender<Record> {
		...
		*/
		Appender() throws IOException {
			_mdb = TradeMDB.this;
			if (!_memory) {
				_buf = ByteBuffer.allocate(_bufferSize * 104);
				reconnectFile();
			}
		}
		...
		*/
		...
		public synchronized boolean next() throws IOException {
			...
			if (!_memory) {
				...
				this.eventTime = _buffer.getLong();
	...
	public Cursor cursor() throws IOException {
		...
		*/
		public final class RandomCursor implements IRandomCursor<Record> {
			...
			ByteBuffer _buffer_eventTime; // used by index-of-eventTime method.
			...
			RandomCursor() throws IOException {
				...
				if (!_memory) {
					...
					_buffer_eventTime = ByteBuffer.allocate(8);
	...
	*/
	 ...
	 * @param val_eventTime The value for column eventTime.
	...
	* @throws IOException If there is any I/O error.
	...
	public void replace(long index 
		...
		try {
			...
			_replaceBuffer.putLong(val_eventTime);
			...
			_replaceBuffer.rewind();
			appender();
			_appender._channel.write(_replaceBuffer, index * 104);
		} finally {
	 ...
	 * Also you can use {@link #replace(long , long, double, long, double, boolean, boolean, boolean, int, long, byte, long, long, long, long, long, int, int, int, int)}.
	 *
	 * @param index The index to update.
	 * @param record Contains the data to set.
	 * @see #replace(long , long, double, long, double, boolean, boolean, boolean, int, long, byte, long, long, long, long, long, int, int, int, int)
	 * @throws IOException If there is any I/O error.
	 */
	 ...
	 * update many fields of the record then use {@link #replace(long , long, double, long, double, boolean, boolean, boolean, int, long, byte, long, long, long, long, long, int, int, int, int)},
	...
	public void replace_openTime(long index, long value) throws IOException {
		...
		try {
			...
			_replaceBuffer_openTime.rewind();
			appender();
			_appender._channel.write(_replaceBuffer_openTime, index * 104 + 0);
		} finally {
			if (!_basic) _writeLock.unlock();
		}		
	}
	...
	public void replace_openPrice(long index, double value) throws IOException {
		...
		try {
			...
			_replaceBuffer_openPrice.rewind();
			appender();
			_appender._channel.write(_replaceBuffer_openPrice, index * 104 + 8);
		} finally {
			if (!_basic) _writeLock.unlock();
		}		
	}
	...
	public void replace_closeTime(long index, long value) throws IOException {
		...
		try {
			...
			_replaceBuffer_closeTime.rewind();
			appender();
			_appender._channel.write(_replaceBuffer_closeTime, index * 104 + 16);
		} finally {
			if (!_basic) _writeLock.unlock();
		}		
	}
	...
	public void replace_closePrice(long index, double value) throws IOException {
		...
		try {
			...
			_replaceBuffer_closePrice.rewind();
			appender();
			_appender._channel.write(_replaceBuffer_closePrice, index * 104 + 24);
		} finally {
			if (!_basic) _writeLock.unlock();
		}		
	}
	...
	public void replace_isGain(long index, boolean value) throws IOException {
		...
		try {
			...
			_replaceBuffer_isGain.rewind();
			appender();
			_appender._channel.write(_replaceBuffer_isGain, index * 104 + 32);
		} finally {
			if (!_basic) _writeLock.unlock();
		}		
	}
	...
	public void replace_isClosed(long index, boolean value) throws IOException {
		...
		try {
			...
			_replaceBuffer_isClosed.rewind();
			appender();
			_appender._channel.write(_replaceBuffer_isClosed, index * 104 + 33);
		} finally {
			if (!_basic) _writeLock.unlock();
		}		
	}
	...
	public void replace_isLong(long index, boolean value) throws IOException {
		...
		try {
			...
			_replaceBuffer_isLong.rewind();
			appender();
			_appender._channel.write(_replaceBuffer_isLong, index * 104 + 34);
		} finally {
			if (!_basic) _writeLock.unlock();
		}		
	}
	...
	public void replace_orderId(long index, int value) throws IOException {
		...
		try {
			...
			_replaceBuffer_orderId.rewind();
			appender();
			_appender._channel.write(_replaceBuffer_orderId, index * 104 + 35);
		} finally {
			if (!_basic) _writeLock.unlock();
		}		
	}
	/**
	 * Update the record at the given <code>index</code>, 
	 * but only the column "eventTime" is updated. If you like to 
	 * update many fields of the record then use {@link #replace(long , long, double, long, double, boolean, boolean, boolean, int, long, byte, long, long, long, long, long, int, int, int, int)},
	 * but if you want to update just one column, use this method because it is faster.
	 * 
	 * @param index The index of the record to update.
	 * @param value The new value to set to the column "eventTime".
	 *
	 * @throws IOException If there is any I/O error.
	 */
	public void replace_eventTime(long index, long value) throws IOException {
		if (!_basic) _writeLock.lock();
		try {
			if (!_basic) {
				if (index >= _rbufPos) {
					int pos = (int) (index - _rbufPos);
					if (pos < _rbufSize) {
						_rbuf[pos].eventTime = value;
					}
					return;
				} 				
			}
		
			_replaceBuffer_eventTime.rewind();
			_replaceBuffer_eventTime.putLong(value);
			_replaceBuffer_eventTime.rewind();
			appender();
			_appender._channel.write(_replaceBuffer_eventTime, index * 104 + 39);
		} finally {
			if (!_basic) _writeLock.unlock();
		}		
	}
	...
	public void replace_openingCount(long index, byte value) throws IOException {
		...
		try {
			...
			_replaceBuffer_openingCount.rewind();
			appender();
			_appender._channel.write(_replaceBuffer_openingCount, index * 104 + 47);
		} finally {
			if (!_basic) _writeLock.unlock();
		}		
	}
	...
	public void replace_opening0(long index, long value) throws IOException {
		...
		try {
			...
			_replaceBuffer_opening0.rewind();
			appender();
			_appender._channel.write(_replaceBuffer_opening0, index * 104 + 48);
		} finally {
			if (!_basic) _writeLock.unlock();
		}		
	}
	...
	public void replace_opening1(long index, long value) throws IOException {
		...
		try {
			...
			_replaceBuffer_opening1.rewind();
			appender();
			_appender._channel.write(_replaceBuffer_opening1, index * 104 + 56);
		} finally {
			if (!_basic) _writeLock.unlock();
		}		
	}
	...
	public void replace_openPhysicalTime(long index, long value) throws IOException {
		...
		try {
			...
			_replaceBuffer_openPhysicalTime.rewind();
			appender();
			_appender._channel.write(_replaceBuffer_openPhysicalTime, index * 104 + 64);
		} finally {
			if (!_basic) _writeLock.unlock();
		}		
	}
	...
	public void replace_closePhysicalTime(long index, long value) throws IOException {
		...
		try {
			...
			_replaceBuffer_closePhysicalTime.rewind();
			appender();
			_appender._channel.write(_replaceBuffer_closePhysicalTime, index * 104 + 72);
		} finally {
			if (!_basic) _writeLock.unlock();
		}		
	}
	...
	public void replace_eventPhysicalTime(long index, long value) throws IOException {
		...
		try {
			...
			_replaceBuffer_eventPhysicalTime.rewind();
			appender();
			_appender._channel.write(_replaceBuffer_eventPhysicalTime, index * 104 + 80);
		} finally {
			if (!_basic) _writeLock.unlock();
		}		
	}
	...
	public void replace_opening0_childType(long index, int value) throws IOException {
		...
		try {
			...
			_replaceBuffer_opening0_childType.rewind();
			appender();
			_appender._channel.write(_replaceBuffer_opening0_childType, index * 104 + 88);
		} finally {
			if (!_basic) _writeLock.unlock();
		}		
	}
	...
	public void replace_opening1_childType(long index, int value) throws IOException {
		...
		try {
			...
			_replaceBuffer_opening1_childType.rewind();
			appender();
			_appender._channel.write(_replaceBuffer_opening1_childType, index * 104 + 92);
		} finally {
			if (!_basic) _writeLock.unlock();
		}		
	}
	...
	public void replace_opening0_orderId(long index, int value) throws IOException {
		...
		try {
			...
			_replaceBuffer_opening0_orderId.rewind();
			appender();
			_appender._channel.write(_replaceBuffer_opening0_orderId, index * 104 + 96);
		} finally {
			if (!_basic) _writeLock.unlock();
		}		
	}
	...
	public void replace_opening1_orderId(long index, int value) throws IOException {
		...
		try {
			...
			_replaceBuffer_opening1_orderId.rewind();
			appender();
			_appender._channel.write(_replaceBuffer_opening1_orderId, index * 104 + 100);
		} finally {
			if (!_basic) _writeLock.unlock();
		}		
	}
	...
	*/
	 ...
	 *			The sequential cursor used to collect the data.
	 * @param lower
	 *			The lower value of <code>eventTime</code>.
	 * @param upper
	 *			The upper value of <code>eventTime</code>
	 * @return The data between the lower and upper values.
	 * @throws IOException If there is any I/O error.
	 */	
	public Record[] select__where_EventTime_in(RandomCursor randCursor, Cursor cursor, long lower, long upper) throws IOException {
		if (_size == 0) return NO_DATA;
		
		long start = indexOfEventTime(randCursor, lower) - 1;
	...
	/**
	* Like {@link #select__where_EventTime_in(RandomCursor, Cursor, long, long)} but it uses a sparse cursor.
	* @param randCursor
	*			The random cursor used to find the indexes and collect sparse data.
	* @param cursor
	*			The sequential cursor used to collect the continuous data. There are cases where the data is not sparse cause the small range of search.
	...
	* @throws IOException If there is any I/O error.
	*/
	public Record[] select_sparse__where_EventTime_in(RandomCursor randCursor, Cursor cursor, long lower, long upper, int maxLen)
			throws IOException {
		if (_size == 0) return NO_DATA;
		
		long start = indexOfEventTime(randCursor, lower) - 1;
		long stop = Math.min(indexOfEventTime(randCursor, upper) + 1, _size - 1);
		...
		if (step < 2) {
			return select__where_EventTime_in(randCursor, cursor, lower, upper);
		}
	...
	*/
	...
	/**
	* Column <code>eventTime</code> order validator.
	*/
	public static final IValidator<Record> EVENTTIME_ASCENDING_VALIDATOR = new IValidator<Record>() {
		@Override
		public boolean validate(ValidationArgs<Record> args, IValidatorListener<Record> listener) {
			Record prev = args.getPrev();
			Record current = args.getCurrent();
			long prevValue = prev.eventTime;
			long curValue = current.eventTime;
			boolean valid = prevValue <= curValue; 
			if (!valid) {
				long row1 = args.getRow() - 1;
				long row2 = args.getRow();
				listener.errorReported(new ValidatorError<>(args, 						
						"eventTime(" + row1 + ")=" + prevValue + " > " + "eventTime(" + row2 + ")=" + curValue + ""));
			}
			return valid;
		}
	};
	...
	*/
	...
	/**
	 * <p>
	 * Record comparator for the column <code>eventTime</code>. 
	 * This comparator takes in consideration the order of the column definition.
	 * </p>
	 */
	public static class EventTimeComparator implements java.util.Comparator<Record> {
		
		@Override
		public int compare(Record o1, Record o2) {
			return o1.eventTime < o2.eventTime? -1 : (o1.eventTime > o2.eventTime? 1 : 0);
		}
	}
	
	/**
	* Like {@link #indexOfEventTime(Record[], long, int, int)}, but searches in the whole array.
	*
	* @param data
	*			The array of data.
	* @param key
	...
	* @return The index of the value.	
	*/
	public static int indexOfEventTime(Record[] data, long key) {
		return indexOfEventTime(data, key, 0, data.length);
	}

	/**
	* <p>
	* From position <code>low</code> to <code>high</code>, this method finds the index 
	* of the record with the eventTime value closer to the given <code>key</code>. 
	* This method uses a binary search algorithm (like <code>Arrays.binarySearch(...)</code>), so it assumes all the records 
	* are ordered by the <code>eventTime</code> order specified in the column definition. 
	* </p>
	* <p>
	* This method is an utility, it does not search on a file, else in an arbitrary array. 
	* </p>
	...
	* @return The index of the value.
	*/
	public static int indexOfEventTime(Record[] data, long key, int low, int high) {
		if (low < 0) throw new IndexOutOfBoundsException("Index: " + low + ", Size: " + data.length);
		...
		while (low1 <= high1) {
		    int mid = (low1 + high1) >>> 1;
		    long midVal = data[mid].eventTime;
		    int cmp = midVal == key ? 0 : (midVal < key ? -1 : 1);
	...
	/**
	* Like {@link #indexOfEventTime(RandomCursor, long, long, long)} but searches on the whole file.
	*
	* @param cursor
	*			Random cursor used to search the value.
	* @param key
	...
	* @throws IOException If there is any I/O error.
	*/
	public long indexOfEventTime(RandomCursor cursor, long key) throws IOException {
		return indexOfEventTime(cursor, key, 0, _size - 1);
	}
	...
	* @throws IOException If there is any I/O error.
	*/
	public long indexOfEventTime(RandomCursor cursor, long key, long low, long high) throws IOException {
		if (!_basic) _readLock.lock();
		try {
			if (low < 0) throw new IndexOutOfBoundsException("Index: " + low + ", Size: " + _size);
			...
			if (!_basic) {
				if (low1 >= _rbufPos || high >= _rbufPos) {
					Record r = _rbuf[0];
					if (_memory || (r.eventTime == key ? 0 
							: (r.eventTime < key ? -1 : 1)) <= 0) {
						/* search in memory */
						return _rbufPos + indexOfEventTime(_rbuf, key, 0, (int) Math.min(high - _rbufPos, _rbufSize - 1));
					}
				}
			}
			...
			FileChannel channel = cursor._channel;
			ByteBuffer buffer = cursor._buffer_eventTime;
				
			while (low1 <= high2) {
				final long mid = (low1 + high2) >>> 1;
				channel.position(mid * 104 + 39);
				buffer.rewind();
				channel.read(buffer);
				buffer.rewind();
	...
	/**
	* Like {@link #indexOfEventTime_exact(Record[], long, int, int)}, 
	* but searches on the whole array.
	* @param data The array of data.
	* @param key The value to search in the array.
	* @return The index of <code>key</code>, or a number &lt; 0 if the key is not found.
	*/
	public static int indexOfEventTime_exact(Record[] data, long key) {
		return indexOfEventTime_exact(data, key, 0, data.length);
	}

	/**
	* Like {@link #indexOfEventTime(Record[], long, int, int)} 
	* but it looks for the exact value, if the value does not exist, returns a number &lt; 0.
	*
	* @param data
	* 			Array or records.
	...
	* @return The index of <code>key</code>, or a number &lt; 0 if the key is not found.
	*/
	public static int indexOfEventTime_exact(Record[] data, long key, int low, int high) {
		if (low < 0) throw new IndexOutOfBoundsException("Index: " + low + ", Size: " + data.length);
	...
	/**
	* Like {@link #indexOfEventTime(RandomCursor, long, long, long)} 
	* but it looks for the exact value, if the value does not exist, returns a number &lt; 0.
	*
	* @param cursor
	*			The cursor used to find the value.
	...
	* @throws IOException If there is any I/O error.	
	*/
	public long indexOfEventTime_exact(RandomCursor cursor, long key, long low, long high) throws IOException {
		if (low < 0) throw new IndexOutOfBoundsException("Index: " + low + ", Size: " + _size);
			...
			if (!_basic) {
				if (low1 >= _rbufPos || high >= _rbufPos) {
					...
					if (_memory || (r.eventTime == key ? 0 
							: (r.eventTime < key ? -1 : 1)) <= 0) {
						/* search in memory */
						long index = indexOfEventTime_exact(_rbuf, key, 0, (int) Math.min(high - _rbufPos, _rbufSize - 1));
						return index < 0? -_rbufPos + index /* key no found */ : _rbufPos + index;
					}
				}
			}
	...
	/**
	 * Like {@link #indexOfEventTime_exact(RandomCursor, long, long, long)}, but searches on the whole file.
	 *
	 * @param cursor The random cursor used to find the value.
	 * @param key The value to search.
	 * @return The index of the value. 
	 * @throws IOException If there is any I/O error.
	 */
	public long indexOfEventTime_exact(RandomCursor cursor, long key) throws IOException {
		return indexOfEventTime_exact(cursor, key, 0, _size - 1);
	}
	
	/**
	* Search the index of the given eventTime and then truncate the database in that position.
	*
	* @param randCursor The cursor used to find the position of eventTime.
	* @param eventTime Truncate the file in the index of this value.
	* @throws IOException If there is any I/O error.
	*/
	public void truncateEventTime(RandomCursor randCursor, long eventTime) throws IOException {
		if (_size > 0) {
			long len = indexOfEventTime(randCursor, eventTime);
			if (len > 0) {
				len--;
			}
			while (len < _size) {
				randCursor.seek(len);
				if (randCursor.eventTime > eventTime) {
					break;
				}
				len++;
			}
	...
	/**
	* Find the record with <code>eventTime</code> equals to the given value.
	* 
	* @param cursor The random cursor used to find the indexes.
	* @param eventTime The value to find.
	*
	* @return The found record or <code>null</code> if there is not any record with that value.
	* @throws IOException If there is any I/O error.
	*/
	public Record findRecord_where_eventTime_is(RandomCursor cursor, long eventTime) throws IOException {
		if (_size > 0) {
			long i = indexOfEventTime_exact(cursor, eventTime);
			if (i < 0) {
				return null;
			}
			cursor.seek(i);
			Record r = cursor.toRecord();
			assert r.eventTime == eventTime;
			return r;
		}
		return null;
	}
	...
	/**
	 * Count the number of records between the eventTime values <code>keyLower</code> and <code>keyUpper</code>.
	 * If there are not records with those values, then it returns an approximation.
	 *
	 * @param cursor The random cursor used to find the indexes.
	 * @param keyLower The value to start counting.
	 ...
	 * @throws IOException If there is any I/O error.
	 */
	public long countEventTime(RandomCursor cursor, long keyLower, long keyUpper) throws IOException {
		if (_memory) {
			long high = _size - 1;
			long a = indexOfEventTime(null, keyLower, 0L, high);
			long b = indexOfEventTime(null, keyUpper, 0L, high);
			return b - a;
		}
		
		long high = _size - 1;
		long a = indexOfEventTime(cursor, keyLower, 0L, high);
		long b = indexOfEventTime(cursor, keyUpper, 0L, high);
		return b - a;
	}
	/**
	 * <p>
	...
	*/
	...
	public long fsize() throws IOException {		
		return _memory? 0 : _file.length() / 104;
	}
