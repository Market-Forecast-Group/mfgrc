...
/**
 * <p>
 * This class provides the API to manipulate InterpPriceProb files. 
 * Here you will find the methods to modify and query the InterpPriceProb files. 
 * </p>
 * <p>
 ...
 * </p>
 * <h3>InterpPriceProb definition</h3>
 * <table border=1>
 *	<caption>InterpPriceProb</caption>
 *	<tr>
 *		<td>Column</td>
 *		<td>Type</td>
 *		<td>Order</td>
 ...
 *	</tr>
 * </table>
 * <h3>InterpPriceProbMDB API</h3>
 * <p>
 * Now let's see the operations you can perform using this class on InterpPriceProb files:
 * </p>
 *
 ...
 * InterpPriceProbMDB mdb = session.connectTo_InterpPriceProbMDB("interppriceprob.mdb");
 * 
 * // request the appender.
 * InterpPriceProbMDB.Appender app = mdb.appender(); 
 *
 ...
 * </p>
 * <pre>
 * InterpPriceProbMDB mdb = ...;
 * long start = ...;
 * long stop = ...;
 *
 * // request a sequential cursor from start to stop
 * InterpPriceProb.Cursor cursor = mdb.cursor(start, stop);
 *
 ...
 * InterpPriceProbMDB.RandomCursor cursor = mdb.randomCursor();
 *
 ...
 * </p>
 * <ul>
 * <li>{@link InterpPriceProbMDB#replace_time(long, long)}: To replace the time value.</li>
 * <li>{@link InterpPriceProbMDB#replace_price(long, double)}: To replace the price value.</li>
 * </ul>
 *
 * <h3>List API</h3>
 * TODO: Documentation is comming
 *
 * @see BaseChartMDBSession#connectTo_InterpPriceProbMDB(String)
 */

public final class InterpPriceProbMDB
/* BEGIN MDB EXTENDS */
		extends MDB<InterpPriceProbMDB.Record>
/* END MDB EXTENDS */
{
...
/* END USER MDB */
	/**
	 * InterpPriceProb's meta-data: column names.
	 */
	...
	/**
	 * InterpPriceProb's meta-data: column Java types.
	 */
	...
	/**
	 * InterpPriceProb's meta-data: column Java types size (in bytes).
	 */
	...
	/**
	 * InterpPriceProb's meta-data: virtual column flags.
	 */
	...
	/**
	 * InterpPriceProb's meta-data: column byte-offset.
	 */
	...
	/**
	 * InterpPriceProb's meta-data: size of the record, in bytes.
	 */
	...
	*/	
	...
	/**
	 * InterpPriceProb's meta-data: UUID used in schemas.
	 */
	public static final String TABLE_ID = "0273e857-d040-48e4-979a-4e5080953773";
	
	/**
	 * InterpPriceProb's meta-data: signature used to check schema changes.
	 */ 
	public static final String TABLE_SIGNATURE = "80e9a018-31b1-46be-a7c5-8f4c9b9f0388 LONG; d2f9c075-e98f-44ab-8d49-86e69328cb69 DOUBLE; ";
	 ...
	 */
	public InterpPriceProbMDB(BaseChartMDBSession session, File file, int bufferSize, SessionMode mode) throws IOException {
	...
	/**
	* InterpPriceProb record structure.
	*/
...
/**
	...
	*/
	public final class Appender implements IAppender<Record> {
		...
		protected InterpPriceProbMDB _mdb;	
		...
		*/
		@Override
		public InterpPriceProbMDB getMDB() {
			return _mdb;
		}
	...
	*/
	...
	public final class Cursor implements ISeqCursor<Record> {
		...
		*/
		@Override
		public InterpPriceProbMDB getMDB() {
			return InterpPriceProbMDB.this;
		}
	}
