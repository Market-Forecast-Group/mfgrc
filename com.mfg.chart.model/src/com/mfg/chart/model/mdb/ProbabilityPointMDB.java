...
/**
 * <p>
 * This class provides the API to manipulate ProbabilityPoint files. 
 * Here you will find the methods to modify and query the ProbabilityPoint files. 
 * </p>
 * <p>
 ...
 * </p>
 * <h3>ProbabilityPoint definition</h3>
 * <table border=1>
 *	<caption>ProbabilityPoint</caption>
 *	<tr>
 *		<td>Column</td>
 *		<td>Type</td>
 *		<td>Order</td>
 ...
 *	</tr>
 * </table>
 * <h3>ProbabilityPointMDB API</h3>
 * <p>
 * Now let's see the operations you can perform using this class on ProbabilityPoint files:
 * </p>
 *
 ...
 * ProbabilityPointMDB mdb = session.connectTo_ProbabilityPointMDB("probabilitypoint.mdb");
 * 
 * // request the appender.
 * ProbabilityPointMDB.Appender app = mdb.appender(); 
 *
 ...
 * </p>
 * <pre>
 * ProbabilityPointMDB mdb = ...;
 * long start = ...;
 * long stop = ...;
 *
 * // request a sequential cursor from start to stop
 * ProbabilityPoint.Cursor cursor = mdb.cursor(start, stop);
 *
 ...
 * ProbabilityPointMDB.RandomCursor cursor = mdb.randomCursor();
 *
 ...
 * </p>
 * <ul>
 * <li>{@link ProbabilityPointMDB#replace_time(long, long)}: To replace the time value.</li>
 * <li>{@link ProbabilityPointMDB#replace_price(long, double)}: To replace the price value.</li>
 * </ul>
 *
 * <h3>List API</h3>
 * TODO: Documentation is comming
 *
 * @see BaseChartMDBSession#connectTo_ProbabilityPointMDB(String)
 */

public final class ProbabilityPointMDB
/* BEGIN MDB EXTENDS */
		extends MDB<ProbabilityPointMDB.Record>
/* END MDB EXTENDS */
{
...
/* END USER MDB */
	/**
	 * ProbabilityPoint's meta-data: column names.
	 */
	...
	/**
	 * ProbabilityPoint's meta-data: column Java types.
	 */
	...
	/**
	 * ProbabilityPoint's meta-data: column Java types size (in bytes).
	 */
	...
	/**
	 * ProbabilityPoint's meta-data: virtual column flags.
	 */
	...
	/**
	 * ProbabilityPoint's meta-data: column byte-offset.
	 */
	...
	/**
	 * ProbabilityPoint's meta-data: size of the record, in bytes.
	 */
	...
	*/	
	...
	/**
	 * ProbabilityPoint's meta-data: UUID used in schemas.
	 */
	public static final String TABLE_ID = "318d0774-d2af-4801-b71b-a79a668b86c6";
	
	/**
	 * ProbabilityPoint's meta-data: signature used to check schema changes.
	 */ 
	public static final String TABLE_SIGNATURE = "c5d17ab8-dd0c-4ca2-8e24-2adc42049ded LONG; f3a1f73e-c3ee-461a-b033-176832c8f6de DOUBLE; ";
	 ...
	 */
	public ProbabilityPointMDB(BaseChartMDBSession session, File file, int bufferSize, SessionMode mode) throws IOException {
	...
	/**
	* ProbabilityPoint record structure.
	*/
...
/**
	...
	*/
	public final class Appender implements IAppender<Record> {
		...
		protected ProbabilityPointMDB _mdb;	
		...
		*/
		@Override
		public ProbabilityPointMDB getMDB() {
			return _mdb;
		}
	...
	*/
	...
	public final class Cursor implements ISeqCursor<Record> {
		...
		*/
		@Override
		public ProbabilityPointMDB getMDB() {
			return ProbabilityPointMDB.this;
		}
	}
	...
	* @throws IOException If there is any I/O error.
	 ...
	 * Also you can use {@link #replace(long , long, double)}.
	 *
	 * @param index The index to update.
	 * @param record Contains the data to set.
	 * @see #replace(long , long, double)
	 * @throws IOException If there is any I/O error.
	 */
	 ...
	 * update many fields of the record then use {@link #replace(long , long, double)},
	...
	public void replace_time(long index, long value) throws IOException {
		...
		try {
			...
			_replaceBuffer_time.rewind();
			appender();
			_appender._channel.write(_replaceBuffer_time, index * 16 + 0);
		} finally {
			if (!_basic) _writeLock.unlock();
		}		
	}
	...
	public void replace_price(long index, double value) throws IOException {
		...
		try {
			...
			_replaceBuffer_price.rewind();
			appender();
			_appender._channel.write(_replaceBuffer_price, index * 16 + 8);
		} finally {
			if (!_basic) _writeLock.unlock();
		}		
	}
