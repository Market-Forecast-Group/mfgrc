 ...
 *
 * @see TradingMDBSession#connectTo_ProbabilityPointMDB(String)
 */
...
/* END USER MDB */
	...
	*/	
	 ...
	 */
	public static final String TABLE_ID = "7d81f05b-afc7-4029-8327-53887b876e5d";
	
	/**
	 * ProbabilityPoint's meta-data: signature used to check schema changes.
	 */ 
	public static final String TABLE_SIGNATURE = "5f5cf441-ee7b-4d9f-a172-a4cc8acb8abc LONG; f451d3c5-6be4-4b7a-a271-ed4b948584a7 DOUBLE; ";
	 ...
	 */
	public ProbabilityPointMDB(TradingMDBSession session, File file, int bufferSize, SessionMode mode) throws IOException {
