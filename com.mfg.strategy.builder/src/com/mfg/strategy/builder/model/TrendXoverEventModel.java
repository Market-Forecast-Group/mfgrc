...
import com.mfg.strategy.automatic.eventPatterns.EventAtomTrendXover;
...
public class TrendXoverEventModel extends ScaledEventModel implements IContrarian {
	...
	public String getLabel() {
		return "TREND XOVER{scale=" + widgetScale + ((!isLimitedToSwing0()) ? "" : (", on Sw0 ")) + "}";
	}
	...
	public EventGeneral exportMe() {
		EventAtomTrendXover res = new EventAtomTrendXover();
