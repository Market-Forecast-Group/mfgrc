 ...
 * 
 */
public class EventLabelProvider extends StrategyLogLabelProvider {

	/*
	 * (non-Javadoc)
	 * 
	 * @see
	 * com.mfg.strategy.logger.ui.StrategyLogLabelProvider#getText(java.lang
	 * .Object)
	 */
	@Override
	public String getText(Object element) {
		return getText(getMessage(element));
	}
