...
/**
 * A special abstract preference page to host field editors and eny other
 * controls with flexible layout.
 * <p>
...
public abstract class FieldLayoutPreferencePage extends PreferencePage
	...
	/**
	 * Creates a new field editor preference page with the given title, but no
	 * image.
	 * 
	 * @param title
