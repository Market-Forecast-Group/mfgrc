 ...
 * 
 */
public class TurnOnOffAutorangeHandler extends AbstractChartViewHanlder {
	...
	protected Object execute(AbstractChartView view, ExecutionEvent event) {
		...
		boolean enabled = !chart.isAutoRangeEnabled();
		chart.setAutoRangeEnabled(enabled);
		chart.update(enabled);
		return null;
	}
