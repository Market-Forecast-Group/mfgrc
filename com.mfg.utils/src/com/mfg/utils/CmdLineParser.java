...
public class CmdLineParser {
	...
	public static class UnknownOptionException extends OptionException {
		...
		UnknownOptionException(String optionName1) {
			this(optionName1, "Unknown option '" + optionName1 + "'");
		}

		UnknownOptionException(String optionName1, String msg) {
			super(msg);
	...
	public static class UnknownSuboptionException extends
		...
		UnknownSuboptionException(String option, char suboption1) {
			super(option, "Illegal option: '" + suboption1 + "' in '" + option
					+ "'");
			this.suboption = suboption1;
		}
	...
	public static class IllegalOptionValueException extends OptionException {
		...
		public IllegalOptionValueException(Option opt, String value1) {
			super("Illegal value '"
					+ value1
					+ "' for option "
	...
	public static abstract class Option {
		...
		protected Option(String longForm1, boolean wantsValue1) {
			this(null, longForm1, wantsValue1);
		}

		protected Option(char shortForm1, String longForm1, boolean wantsValue1) {
			this(new String(new char[] { shortForm1 }), longForm1, wantsValue1);
		}

		private Option(String shortForm1, String longForm1, boolean wantsValue1) {
			if (longForm1 == null)
				throw new IllegalArgumentException("Null longForm not allowed");
			this.shortForm = shortForm1;
			this.longForm = longForm1;
			this.wantsValue = wantsValue1;
		}
	...
	public final Object getOptionValue(Option o, Object def) {
		Vector v = values.get(o.longForm());
